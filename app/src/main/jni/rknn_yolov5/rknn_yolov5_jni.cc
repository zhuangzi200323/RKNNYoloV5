...
Java_com_sq_rknn_yolov5_YoloV5Detect_init(JNIEnv *env, jobject thiz, jstring jmodel_path,
...
JNIEXPORT jboolean JNICALL
Java_com_sq_rknn_yolov5_YoloV5Detect_detect(JNIEnv *env, jobject thiz, jobject jbitmap) {
...
Java_com_sq_rknn_yolov5_YoloV5Detect_detect2(JNIEnv *env, jobject thiz, jobject jbitmap) {
    AndroidBitmapInfo dstInfo;
    ...
    // 获取 Java 类和构造函数
    jclass detectionResultClass = env->FindClass("com/sq/rknn/yolov5/DetectionResult");
    jclass objectResultClass = env->FindClass("com/sq/rknn/yolov5/DetectionResult$ObjectResult");
    ...
    jmethodID addMethod = env->GetMethodID(detectionResultClass, "addObjectResult", "(Lcom/sq/rknn/yolov5/DetectionResult$ObjectResult;)V");
...
JNIEXPORT jboolean JNICALL
Java_com_sq_rknn_yolov5_YoloV5Detect_release(JNIEnv *env, jobject thiz) {
    deInit_post_process();
